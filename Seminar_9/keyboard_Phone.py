...
keyboard_input_file = types.InlineKeyboardMarkup()
keyboard_input_file.row(   types.InlineKeyboardButton('Импорт из файла "csv"', callback_data='Импорт из файла "csv"'),
                    types.InlineKeyboardButton('Импорт из файла "html"', callback_data='Импорт из файла "html"'))
keyboard_input_file.row(   types.InlineKeyboardButton('Выход в главное меню', callback_data='Выход в главное меню'))
...
lst_text = ['Ввод данных', 'Редактировать', 'Экспорт данных из файла', 'Вывод списка на экран', 'Ввод данных с клавиатуры', 'Импорт данных из файла', 'Выход в главное меню',
 ...
 'Экспортировать файл "xml"', 'Меню вывода информации', 'Экспортировать файл "html"', 'Импорт из файла "csv"', 'Импорт из файла "html"']